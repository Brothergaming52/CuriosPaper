...
public class RecipeData {
  ...
  public RecipeData(RecipeType type) {
    ...
    if (type == RecipeType.SHAPED) {
      ...
      this.cookingTime = type == RecipeType.CAMPFIRE ? 600 : 200; // Campfire default 30s, others 10s
      this.experience = type == RecipeType.CAMPFIRE ? 0.35f : 0.5f;
    }
  }
  ...
  public static RecipeData loadFromConfig(ConfigurationSection config) {
    ...
    if (type == RecipeType.SHAPED || type == RecipeType.SHAPELESS) {
      ...
      data.setCookingTime(config.getInt("cooking-time", type == RecipeType.CAMPFIRE ? 600 : 200));
